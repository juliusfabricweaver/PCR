        ...
        <div className="card">
          <div className="card-header">
            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-3">
              <div>
                <h3 className="text-lg font-medium text-gray-900 dark:text-gray-100">Medical Acronyms</h3>
                <p className="mt-1 text-sm text-gray-600 dark:text-gray-400">
          ...
          <div className="card-body">
            {filteredAcronyms.length === 0 ? (
              <div className="text-sm text-gray-600 dark:text-gray-400">No acronyms found for this filter.</div>
            ) : (
              <>
                      ...
                      <div className="flex items-start justify-between gap-3">
                        <div>
                          <div className="flex items-center gap-2">
                            <span className="text-sm font-semibold text-gray-900 dark:text-gray-100">{item.acronym}</span>
                          ...
                          <p className="mt-1 text-sm text-gray-700 dark:text-gray-300">{item.meaning}</p>
                        </div>
